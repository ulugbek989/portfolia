<div class="mt-6 mb-10">
    ...
    <button class="btn btn-info mb-2 d-flex" type="button" wire:click="createModal"><svg xmlns="http://www.w3.org/2000/svg"
    ...
    <span>no create, than one is possible</span>
</button>
    @endif
                ...
                <table class="table table-centered table-nowrap mb-0 rounded">
                    ...
                    <tbody>
                        @foreach ($contacts as $contact)
                            <tr>
                                <td><a href="#" class="text-primary fw-bold">{{ $contact->id }}</a></td>
                                <td class="fw-bold d-flex align-items-center">
                                    <img src="{{ asset('storage/' . $contact->img) }}" class="w-25">
                                </td>
                                <td>{{ $contact->title_ru }}</td>
                                <td>{{  Str::limit($contact->text_ru, 40, ' (...)');}}</td>
                                ...
                                <td class="text-success">
                                    <div class="d-flex align-items-center">
                                        <a href="#" wire:click="updateModal( {{ $contact->id }})"
                                            class="me-3">
                                        ...
                                        <a href="#" wire:click="deleteModal({{ $contact->id }})"
                                            class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <!-- Modal Content -->
    @include('livewire.admin.contact.modal-contact')
    @include('livewire.admin.contact.delete')
