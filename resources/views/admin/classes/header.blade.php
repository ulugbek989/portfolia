            ...
            <ul class="navbar-nav align-items-center">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ps-0 ms-2">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="text-end"><small class="text-danger">a few
                                                    moments ago</small></div>
                                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ps-0 ms-2">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="text-end"><small class="text-danger">2 hrs
                                                    ago</small></div>
                                        </div>
                ...
                <li class="nav-item dropdown ms-lg-3"><a class="nav-link dropdown-toggle pt-1 px-0" href="#"
                        ...
                        <div class="media d-flex align-items-center"><img class="avatar rounded-circle"
                                alt="Image placeholder" src="{{ Auth::user()->profile_photo_url }}" >
