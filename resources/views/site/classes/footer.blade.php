                ...
                <div class="footer-area text-center">
                    ...
                    <div class="logo">
                        <a href="https://t.me/bekboy_uz">
                            ...
                            <img class="rounded-circle" src="{{asset('image/'. '1.jpg')}}" alt="logo">
                        </a>
                    </div>

                    <p class="description mt--30">© 2022.<a href="https://t.me/bekboy_uz">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-telegram m-2" viewBox="0 0 18 15">
                          ...
                          </svg></a> <a target="_blank" href="https://t.me/bekboy_uz">Portfolia</a></p>
                </div>
            </div>
        </div>
    </div>
